...
# Async, fast, and modern Python framework
...
<Steps>
  ...
  <Step title="Documentation">
    Use the markdown template to document your spider
  </Step>
  <Step title="Examples">
    Provide example URLs and expected output
  </Step>
  <Step title="License">
    Choose a license (MIT, Apache, CC0)
  </Step>
</Steps>
